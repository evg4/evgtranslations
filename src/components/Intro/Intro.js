    ...
    <section className={styles.banner}>
      ...
      <div className={styles.bannerExtra}>
        ...
        <p>
          ...
          <br></br>
          <br></br> Are you an agency looking for more freelancers? I have 3
          years of experience working in a translation agency so know what it’s
          like to be on the other side of the computer screen; I always deliver
          work on time and am happy to use your specific style guides or CAT
          tools to make the translation process run smoothly.<br></br>
          <br></br> Whatever your translation needs, keep reading to find out
          more about me and the services I offer, and please do get in touch for
          more details or a no-obligation quote.
        </p>
      </div>
    </section>
  );
